var subjectdb = [
    ['M1','APPLIED PHYSICS','PPS','CAEG','COI'],
    ['M2','ENGINEERING CHEMISTRY','BEE','ECE','IT TOOLS'],
    ['BFE','M3','DTPI','DS','PWP'],
    ['HROB','M4','COA','MM','OOPS'],
...
function getVars() {
  var examDate = document.getElementById("exam_date").value;
    var nod = document.getElementById("no_of_days").value;

    if (!examDate && !nod) {
        alert("Please enter either the exam date or the number of days left for the exam.");
        return;
    }
